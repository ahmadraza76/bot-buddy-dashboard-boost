      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <Card className="bg-white shadow-sm border">
          <CardHeader className="pb-3">
            <CardTitle className="text-base font-semibold text-gray-900 text-center">Quick Actions</CardTitle>
        ...
        <Card className="bg-white shadow-sm border">
          <CardHeader className="pb-3">
            <CardTitle className="text-base font-semibold text-gray-900 text-center">Bot Management</CardTitle>
            <CardDescription className="text-sm text-gray-600 text-center">
