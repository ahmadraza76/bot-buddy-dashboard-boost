    ...
    <div className="min-h-screen bg-background p-4 md:p-6">
      <div className="max-w-6xl mx-auto space-y-4 md:space-y-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          <h1 className="text-xl md:text-2xl font-bold text-foreground">Refer & Earn</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          <Card className="bg-card shadow-sm border">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-card-foreground">{referralStats.totalReferrals}</div>
          ...
          <Card className="bg-card shadow-sm border">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-card-foreground">₹{referralStats.totalEarnings}</div>
          ...
          <Card className="bg-card shadow-sm border">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-card-foreground">{referralStats.thisMonthReferrals}</div>
          ...
          <Card className="bg-card shadow-sm border">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-card-foreground">{referralStats.conversionRate}</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          <Card className="bg-card shadow-sm border">
            <CardHeader>
              <CardTitle className="text-card-foreground">Your Referral Link</CardTitle>
          ...
          <Card className="bg-card shadow-sm border">
            <CardHeader>
              <CardTitle className="text-card-foreground">Payout Information</CardTitle>
        ...
        <Card className="bg-card shadow-sm border">
          <CardHeader>
            <CardTitle className="text-card-foreground">Referral History</CardTitle>
            <CardDescription>People who joined using your referral link</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              {referralHistory.map((referral, index) => (
                <div key={index} className="flex flex-col sm:flex-row sm:items-center justify-between p-3 rounded-lg border gap-2 sm:gap-0">
                  <div className="flex items-center space-x-3">
                    <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center">
                      <Users className="h-4 w-4 text-primary" />
                    </div>
                    <div>
                      <p className="font-medium text-card-foreground">{referral.name}</p>
                      <p className="text-sm text-muted-foreground">{referral.email}</p>
                    </div>
                  </div>
                  <div className="flex sm:flex-col items-start sm:items-end sm:text-right gap-2 sm:gap-0">
                    <p className="font-medium text-card-foreground">₹{referral.earning}</p>
                    <div className="flex items-center space-x-2">
                      <Badge 
